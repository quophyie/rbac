...
class Rbac {
   ...
   */
  authorize (id, permissions, checkType = null) {
    if (isNaN(id)) {
    ...
    return this._opts
      ...
      .then((principalPermissions) => {
        ...
        switch (checkType) {
          case null:
            granted = Hoek.intersect(permissions, principalPermissions).length === permissions.length
            break
          case 'OR':
            granted = Hoek.contain(permissions, principalPermissions)
            break
          case 'AND':
            granted = Hoek.deepEqual(permissions, principalPermissions, { prototype: false })
            break
        }
