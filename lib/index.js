...
class Rbac {
   ...
   * `function (id, permissions)` and returning a Promise. **If `opts.remoteAuth` is not set, then this property is
   * required.**
   ...
   * define the `checkPermission` callback in the instance options.
